...
const AdminReference = () => {
  ...
  return (
    ...
    <Box sx={{ p: isMobile ? 2 : 3 }}>
      <Stack direction={isMobile ? 'column' : 'row'} alignItems="center" justifyContent="space-between" spacing={2} mb={3}>
            ...
            <CardContent>
              <Stack direction="row" alignItems="center" spacing={2}>
                <Avatar sx={{ bgcolor: theme.palette.primary.light }}>
                  <Business sx={{ color: theme.palette.primary.dark }} />
                </Avatar>
                <Box>
            ...
            <CardContent>
              <Stack direction="row" alignItems="center" spacing={2}>
                <Avatar sx={{ bgcolor: theme.palette.success.light }}>
                  <CheckCircle sx={{ color: theme.palette.success.dark }} />
                </Avatar>
                <Box>
                  <Typography variant="subtitle2" color="text.secondary">Completed</Typography>
                  <Typography variant="h4" color="success.main">{totals.completed}</Typography>
                </Box>
              </Stack>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <Stack direction="row" alignItems="center" spacing={2}>
                <Avatar sx={{ bgcolor: theme.palette.warning.light }}>
                  <PendingActions sx={{ color: theme.palette.warning.dark }} />
                </Avatar>
                <Box>
                  <Typography variant="subtitle2" color="text.secondary">Pending</Typography>
                  <Typography variant="h4" color="warning.main">{totals.pending}</Typography>
                </Box>
              </Stack>
            </CardContent>
          </Card>
      ...
      {/* Status Breakdown */}
      <Box sx={{ mb: 3, p: 2, bgcolor: 'background.paper', borderRadius: 2, boxShadow: theme.shadows[1] }}>
        <Typography variant="subtitle1" sx={{ mb: 1, fontWeight: 500 }}>Status Breakdown</Typography>
        <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
          {summary.map((s) => (
            <Badge key={s._id} badgeContent={s.count} color="primary" sx={{ mr: 1, mb: 1 }}>
              <StatusChip
                status={s._id}
                label={s._id}
