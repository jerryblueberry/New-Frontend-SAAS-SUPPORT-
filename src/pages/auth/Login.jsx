  ...
  return (
    <div className="login__container">
      ...
      <div className="login__branding">
        {/* <img 
          src="/assets/logo.svg" 
          alt="Support Worker Platform Logo" 
        ...
        <h1 className="login__branding-title">
          Welcome to Support Worker Platform
        </h1>
        <p className="login__branding-subtitle">
          Empowering support workers to make a difference in people's lives
        </p>
        <div className="login__quote-container">
          <p className="login__quote">
            "We're here to help you help others"
          </p>
          <p className="login__quote-author">   — every task, every moment, every day</p>
        </div>
      </div>
